...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-white text-black overflow-hidden">
      ...
      <footer className="px-10 py-6 flex-shrink-0 text-center">
        <div className="mt-[60px] mb-3 flex justify-center">
          <a
        ...
        <span className="font-mono text-sm text-gray-400">Alan Mulhall &copy; {new Date().getFullYear()}</span>
      </footer>
    </div>
  );
}
