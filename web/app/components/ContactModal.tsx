...
export default function ContactModal({ onClose }: Props) {
  ...
  // Native <dialog> gives us focus trapping, Escape handling (cancel event)
  // and top-layer rendering. Focus is put back on the opener at unmount.
  useEffect(() => {
  ...
  return (
    ...
    <dialog
      ...
      onCancel={(e) => {
        e.preventDefault(); // keep the dialog open for the slide-out animation
        handleClose();
      }}
      onClick={(e) => {
      ...
      className={`m-0 w-full h-full max-w-none max-h-none bg-white overflow-y-auto
          backdrop:bg-black/20
          md:w-[420px] md:ml-auto
    ...
    >
      <div className="p-8 relative min-h-full">
        ...
        <h2 id="contact-modal-title" className="font-mono text-2xl font-medium mb-6">
          Contact
        </h2>
