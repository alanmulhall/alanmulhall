...
var o__39711__auto___46161 = (function (){var o__39711__auto__ = (function (){var o__39711__auto__ = Promise;
return goog.object.get(o__39711__auto__,"resolve").call(o__39711__auto__);
})();
return goog.object.get(o__39711__auto__,"then").call(o__39711__auto__,callback);
})();
goog.object.get(o__39711__auto___46161,"catch").call(o__39711__auto___46161,devtools.async.rethrow_outside_promise);
...
var G__46163_46164 = Error;
var target__39730__auto___46165 = G__46163_46164;
if(cljs.core.truth_(target__39730__auto___46165)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__46163_46164)].join('')),cljs.core.str("\n"),cljs.core.str("target__39730__auto__")].join('')));
}

goog.object.set(target__39730__auto___46165,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
