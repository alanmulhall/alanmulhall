...
var args46247 = [];
var len__32654__auto___46253 = arguments.length;
var i__32655__auto___46254 = (0);
while(true){
if((i__32655__auto___46254 < len__32654__auto___46253)){
args46247.push((arguments[i__32655__auto___46254]));

var G__46255 = (i__32655__auto___46254 + (1));
i__32655__auto___46254 = G__46255;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox46250 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox46250 = (function (obj,header,style,tag,meta46251){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox46250.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46252,meta46251__$1){
var self__ = this;
var _46252__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox46250(self__.obj,self__.header,self__.style,self__.tag,meta46251__$1));
});

devtools.toolbox.t_devtools$toolbox46250.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46252){
var self__ = this;
var _46252__$1 = this;
return self__.meta46251;
});

devtools.toolbox.t_devtools$toolbox46250.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox46250.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox46250.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox46250.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox46250.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta46251","meta46251",-1947171992,null)], null);
});

devtools.toolbox.t_devtools$toolbox46250.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox46250.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox46250";

devtools.toolbox.t_devtools$toolbox46250.cljs$lang$ctorPrWriter = (function (this__32185__auto__,writer__32186__auto__,opt__32187__auto__){
return cljs.core._write.call(null,writer__32186__auto__,"devtools.toolbox/t_devtools$toolbox46250");
});

devtools.toolbox.__GT_t_devtools$toolbox46250 = (function devtools$toolbox$__GT_t_devtools$toolbox46250(obj__$1,header__$1,style__$1,tag__$1,meta46251){
return (new devtools.toolbox.t_devtools$toolbox46250(obj__$1,header__$1,style__$1,tag__$1,meta46251));
});

}

return (new devtools.toolbox.t_devtools$toolbox46250(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
