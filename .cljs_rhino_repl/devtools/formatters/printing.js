...
var len__32654__auto___46097 = arguments.length;
var i__32655__auto___46098 = (0);
while(true){
if((i__32655__auto___46098 < len__32654__auto___46097)){
args__32661__auto__.push((arguments[i__32655__auto___46098]));

var G__46099 = (i__32655__auto___46098 + (1));
i__32655__auto___46098 = G__46099;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__32662__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq46094){
var G__46095 = cljs.core.first.call(null,seq46094);
var seq46094__$1 = cljs.core.next.call(null,seq46094);
var G__46096 = cljs.core.first.call(null,seq46094__$1);
var seq46094__$2 = cljs.core.next.call(null,seq46094__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__46095,G__46096,seq46094__$2);
});
...
if(cljs.core.truth_((function (){var or__31579__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__32185__auto__,writer__32186__auto__,opt__32187__auto__){
return cljs.core._write.call(null,writer__32186__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__31567__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__31567__auto__){
var or__31579__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__46100_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__46100_SHARP_));
})))){
...
var map__46109 = opts;
var map__46109__$1 = ((((!((map__46109 == null)))?((((map__46109.cljs$lang$protocol_mask$partition0$ & (64))) || (map__46109.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46109):map__46109);
var markup_db = cljs.core.get.call(null,map__46109__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__31579__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e46113){var e__39736__auto__ = e46113;
return false;
}})();
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
...
}catch (e46115){var e__39736__auto__ = e46115;
return false;
}}
})())){
...
var _STAR_current_state_STAR_46120 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__46121 = opts;
...
var markup_db = cljs.core.get.call(null,map__46121__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_46120;
}});
...
;
var temp__4655__auto___46126 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___46126)){
var managed_print_level_46127 = temp__4655__auto___46126;
var _STAR_print_level_STAR_46125_46128 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_46127;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_46125_46128,managed_print_level_46127,temp__4655__auto___46126,writer,opts,job_fn){
return (function (p1__46123_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__46123_SHARP_,null);
});})(_STAR_print_level_STAR_46125_46128,managed_print_level_46127,temp__4655__auto___46126,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_46125_46128;
}} else {
job_fn.call(null);
}
