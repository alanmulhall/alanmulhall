...
var G__46131 = devtools.prefs.pref.call(null,v);
v = G__46131;
continue;
} else {
return v;
...
var and__31567__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__31567__auto__){
var and__31567__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__31579__auto__ = (function (){try{if(!((value == null))){
...
}catch (e46144){var e__39736__auto__ = e46144;
return false;
}})();
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
var or__31579__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e46148){var e__39736__auto__ = e46148;
return false;
}})();
...
}catch (e46150){var e__39736__auto__ = e46150;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__31567__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__31567__auto__)){
var and__31567__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__31567__auto____$1){
...
var and__31567__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__31567__auto__)){
...
var or__31579__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
...
var and__31567__auto__ = (function (){var or__31579__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
...
var vec__46155 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__46155,(0),null);
var name = cljs.core.nth.call(null,vec__46155,(1),null);
...
var and__31567__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__31567__auto__)){
...
var or__31579__auto__ = typeof value === 'string';
if(or__31579__auto__){
return or__31579__auto__;
} else {
var or__31579__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__46158_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46158_SHARP_);
}),template);
});
