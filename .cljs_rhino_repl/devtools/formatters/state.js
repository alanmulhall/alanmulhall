...
var len__32654__auto___44120 = arguments.length;
var i__32655__auto___44121 = (0);
while(true){
if((i__32655__auto___44121 < len__32654__auto___44120)){
args__32661__auto__.push((arguments[i__32655__auto___44121]));

var G__44122 = (i__32655__auto___44121 + (1));
i__32655__auto___44121 = G__44122;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32662__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq44118){
var G__44119 = cljs.core.first.call(null,seq44118);
var seq44118__$1 = cljs.core.next.call(null,seq44118);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__44119,seq44118__$1);
});
...
return (p1__44123_SHARP_ === object);
});})(history))
,history);
});
