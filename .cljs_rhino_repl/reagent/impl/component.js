...
if((i < len)){
var k = (ks[i]);
var G__42806 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__42807 = (i + (1));
m = G__42806;
i = G__42807;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__42811 = c;
var G__42811__$1 = (((G__42811 == null))?null:G__42811.prototype);
if((G__42811__$1 == null)){
return null;
} else {
return (G__42811__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__42815 = c;
var G__42815__$1 = (((G__42815 == null))?null:G__42815.prototype);
if((G__42815__$1 == null)){
return null;
} else {
return (G__42815__$1["render"]);
}
})()));
});
...
return (function() { 
var G__42819__delegate = function (args){
...
while (G__42820__i < G__42820__a.length) {G__42820__a[G__42820__i] = arguments[G__42820__i + 0]; ++G__42820__i;}
  args = new cljs.core.IndexedSeq(G__42820__a,0);
} 
return G__42819__delegate.call(this,args);};
G__42819.cljs$lang$maxFixedArity = 0;
G__42819.cljs$lang$applyTo = (function (arglist__42821){
var args = cljs.core.seq(arglist__42821);
return G__42819__delegate(args);
});
...
var _STAR_current_component_STAR_42824 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_42824;
}});
...
var G__42828 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__42828) {
...
var or__31579__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__42830_42832 = (c["cljsRatom"]);
if((G__42830_42832 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__42830_42832);
}
...
if(cljs.core.truth_((function (){var and__31567__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_42835))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_42836)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_42836))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__31579__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
...
var render_fun__$1 = (function (){var or__31579__auto__ = render_fun;
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__31579__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
...
var name__$1 = (function (){var G__42834 = name;
switch (G__42834) {
case "":
...
var G__42839 = o;
(G__42839[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__42845 = (function (){var or__31579__auto__ = (function (){var G__42847 = c;
if((G__42847 == null)){
return null;
} else {
return (G__42847["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
...
return (G__42845["_currentElement"]);
}
})();
var name = (function (){var G__42848 = elem;
var G__42848__$1 = (((G__42848 == null))?null:(G__42848["type"]));
if((G__42848__$1 == null)){
return null;
} else {
return (G__42848__$1["displayName"]);
}
})();
var path = (function (){var G__42849 = elem;
var G__42849__$1 = (((G__42849 == null))?null:(G__42849["_owner"]));
var G__42849__$2 = (((G__42849__$1 == null))?null:reagent$impl$component$component_path.call(null,G__42849__$1));
if((G__42849__$2 == null)){
return null;
} else {
return [cljs.core.str(G__42849__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__31579__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__31579__auto__)){
return or__31579__auto__;
} else {
var G__42851 = c;
var G__42851__$1 = (((G__42851 == null))?null:G__42851.constructor);
if((G__42851__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__42851__$1);
}
}
})();
