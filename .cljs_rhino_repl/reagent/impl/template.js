...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__32185__auto__,writer__32186__auto__,opt__32187__auto__){
return cljs.core._write.call(null,writer__32186__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__42862 = o;
(G__42862[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__31567__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__31567__auto__){
var and__31567__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__42871 = jsprops;
(G__42871["defaultValue"] = value);

(G__42871["onChange"] = ((function (G__42871,v,value,on_change){
return (function (p1__42868_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__42868_SHARP_);
});})(G__42871,v,value,on_change))
);

(G__42871["ref"] = ((function (G__42871,v,value,on_change){
return (function (p1__42869_SHARP_){
return (this$["cljsInputElement"] = p1__42869_SHARP_);
});})(G__42871,v,value,on_change))
);
...
var vec__42878 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__42878,(0),null);
var id = cljs.core.nth.call(null,vec__42878,(1),null);
var class$ = cljs.core.nth.call(null,vec__42878,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___42883 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___42883 == null)){
} else {
var key_42884 = temp__4661__auto___42883;
(jsprops["key"] = key_42884);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__42886 = (new reagent.impl.template.NativeWrapper());
(G__42886["name"] = c);
...
var len__32654__auto___42892 = arguments.length;
var i__32655__auto___42893 = (0);
while(true){
if((i__32655__auto___42893 < len__32654__auto___42892)){
args__32661__auto__.push((arguments[i__32655__auto___42893]));

var G__42894 = (i__32655__auto___42893 + (1));
i__32655__auto___42893 = G__42894;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32662__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq42890){
var G__42891 = cljs.core.first.call(null,seq42890);
var seq42890__$1 = cljs.core.next.call(null,seq42890);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__42891,seq42890__$1);
});
...
break;
default:
var G__42898 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__42898;
continue;
...
var n__32494__auto___42901 = a.length;
var i_42902 = (0);
while(true){
if((i_42902 < n__32494__auto___42901)){
(a[i_42902] = reagent.impl.template.as_element.call(null,(a[i_42902])));

var G__42903 = (i_42902 + (1));
i_42902 = G__42903;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__32494__auto___42904 = a.length;
var i_42905 = (0);
while(true){
if((i_42905 < n__32494__auto___42904)){
var val_42906 = (a[i_42905]);
if((cljs.core.vector_QMARK_.call(null,val_42906)) && ((reagent.impl.template.key_from_vec.call(null,val_42906) == null))){
(o["no-key"] = true);
} else {
}

(a[i_42905] = reagent.impl.template.as_element.call(null,val_42906));

var G__42907 = (i_42905 + (1));
i_42905 = G__42907;
continue;
} else {
}
...
var ctx = ({});
var vec__42911 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__42911,(0),null);
var derefed = cljs.core.nth.call(null,vec__42911,(1),null);
...
var G__42915 = (cljs.core.count.call(null,argv) - first_child);
switch (G__42915) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__42915){
